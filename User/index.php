...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="assets/img/thunder.png" rel="icon" />
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex justify-content-between">
        <div class="logo">
          ...
          <a href="index.html"
            ><img src="assets/img/thunder.png" alt="" style="max-height: 250px; padding-top: 20px; padding-left: -50px"
          /></a>
        </div>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                href="login.php"
                style="margin-left: 3rem; display: block; text-align: center; padding: 0.5rem 1rem"
                >login</a
              >
            </li>
          </ul>
            ...
            <div class="col-lg-4 mb-4">
              <div class="card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Deleniti optio et nisi dolorem debitis. Aliquam nobis est temporibus sunt ab inventore officiis aut
                    voluptatibus.
                  </p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-newsletter">
              ...
              <p>
                Tamen quem nulla quae legam multos aute sint culpa legam noster magna veniam enim veniam illum dolore
